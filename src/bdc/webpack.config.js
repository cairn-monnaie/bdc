...
module.exports = Object.keys(languages).map(function(language)
{
    ...
    return {
        ...
        entry: {
            ...
            MemberChangeEuroMlc: './static/js/member-change-euro-mlc',
            MemberReconversion: './static/js/member-reconversion',
            EntreeStock: './static/js/entree-stock',
            SortieStock: './static/js/sortie-stock',
            MemberDepotMlcNumerique: './static/js/member-depot-mlc-numerique',
            MemberRetraitMlcNumerique: './static/js/member-retrait-mlc-numerique',
